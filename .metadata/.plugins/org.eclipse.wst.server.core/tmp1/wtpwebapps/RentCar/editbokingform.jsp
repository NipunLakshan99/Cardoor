...
<body onload="startTime()">  
		...
		<%@page import="com.javaUtil.DB.BookingDao,com.javaClass.Booking"%> 
                ...
                <div class="container mt-5" >
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <form class="mt-2" action="editboking.jsp" method="post">
                            <input type="hidden" name="id" value="<%=u.getId() %>"/>  
                            

                                <div class="form-group">
                                    <div class="col-md-5">
                                        <hr> <h4 class="text-left"><b>&nbsp;&nbsp; Edit Booking ! </b></h4><hr>
                                        <label for="date" ><b>Pickup Date</b></label>&nbsp;&nbsp;&nbsp;&nbsp;<br>
                                        <input style="background:transparent;" type="date" class="form-control"  name="pickupdate" value="<%= u.getPickupdate()%>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-5">
                                        ...
                                        <input style="background:transparent;"  type="date" class="form-control" name="returndate" value="<%= u.getReturndate()%>"/>
                                    </div>
                                </div>
