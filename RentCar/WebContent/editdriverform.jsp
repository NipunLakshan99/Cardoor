...
<body onload="startTime()">  
	...
	<%@page import="com.javaUtil.DB.AgentDao,com.javaClass.Agent"%>  
  
	<%
    		String id=request.getParameter("id");  
    	    		Agent u=AgentDao.getRecordById(Integer.parseInt(id));
    	%>  
	...
	<div class="form-group">
	  	<tr><td>Ratings: 
	 		 <select class="custom-select" name="ratings">
      			...
      			<option >1 star Agent</option>
      			<option >2 star Agent</option>
      			<option >3 star Agent</option>
      			<option >4 star Agent</option>
     		</select>
     	</td></tr>	 
  	</div>
	 <br/>
